...
public class FavoriteController extends EpoxyController {
    ...
    public FavoriteController(FavoriteController.EpoxyAdapterCallbacks clickable, LoadMoreRecyclerViewScrollListener listener, int startPage) {
    ...
    protected void buildModels() {
        ...
        if (listNovelModel != null && !listNovelModel.getData().isEmpty()) {
